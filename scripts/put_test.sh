...
## simple tests
# curl -X PUT localhost:9000/store/small_shakespeare.txt --data-binary @in/small_shakespeare.txt -o out/small_shakespeare.txt
# curl -X PUT localhost:9000/store/archive.zip --data-binary @in/archive.zip -o out/archive.zip
